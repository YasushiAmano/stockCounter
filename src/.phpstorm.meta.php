...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'octane.max_requests' => 'string',
            'octane.restart_worker_on_exit' => 'boolean',
            'octane.workers' => 'string',
...
'admin','manager-higher','user-higher',);
...
'filesystems.links./app/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'octane.max_requests','octane.restart_worker_on_exit','octane.workers','queue.default','queue.connections.sync.driver',
...
'livewire.preview-file','dashboard','storage.local',);
...
'DEBUGBAR_ENABLED','APP_TIMEZONE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'AWS_USE_PATH_STYLE_ENDPOINT','OCTANE_SERVER','OCTANE_MAX_REQUESTS','OCTANE_RESTART_WORKER','OCTANE_WORKERS',
'VITE_APP_NAME','VITE_DEV_SERVER_URL',);
